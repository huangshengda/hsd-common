...
public class ResponseConsumerFilter implements Filter {
   ...
   // @SuppressWarnings({"rawtypes", "DuplicatedCode"})
    ...
    //     request.setApplication(invocation.getAttachments().get("application"));
    //     request.setProtocol(RpcProtocolEnum.DUBBO.getCode());
    //     request.setType(RpcTypeEnum.CONSUMER.getCode());
